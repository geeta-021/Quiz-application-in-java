...
public class Quize extends JFrame implements ActionListener{
    ...
    {   super.paint(g);
        ...
        if(timer > 0)
           { g.drawString(time,900,420);}
        else
           {
            g.drawString("times up!!", 900, 420);
            }
        timer--;
        try
        {
